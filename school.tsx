...
import { AlertCircle, CheckCircle, School, MapPin, Mail, Phone, ImagePlus, Plus, Grid, Search, X } from 'lucide-react';
...
// Form Component
const AddSchoolForm = ({ onSuccess, onCancel }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
          ...
          <div className="space-y-6">{/* School Name */}
            <div>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button
                onClick={onCancel}
                className="px-6 py-3 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors"
              >
                Cancel
              </button>
            </div>
...
const ShowSchools = ({ onAddNew }) => {
  ...
  const getSuggestions = (field) => {
    ...
    const uniqueValues = [...new Set(schools.map(school => school[field]))];
    return uniqueValues
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                ...
                onFocus={() => tempFilters.name && setShowSuggestions(prev => ({ ...prev, name: true }))}
              ...
              {showSuggestions.name && getSuggestions('name').length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {getSuggestions('name').map((suggestion, index) => (
                    <div
                      key={index}
                      onClick={() => selectSuggestion('name', suggestion)}
                      className="px-4 py-2 hover:bg-indigo-50 cursor-pointer text-sm text-gray-700 border-b last:border-b-0"
                    >
                      {suggestion}
                    </div>
                  ))}
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleTempFilterChange}
                onKeyPress={handleKeyPress}
                onFocus={() => tempFilters.city && setShowSuggestions(prev => ({ ...prev, city: true }))}
              ...
              {showSuggestions.city && getSuggestions('city').length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {getSuggestions('city').map((suggestion, index) => (
                    <div
                      key={index}
                      onClick={() => selectSuggestion('city', suggestion)}
                      className="px-4 py-2 hover:bg-indigo-50 cursor-pointer text-sm text-gray-700 border-b last:border-b-0"
                    >
                      {suggestion}
                    </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleTempFilterChange}
                onKeyPress={handleKeyPress}
                onFocus={() => tempFilters.state && setShowSuggestions(prev => ({ ...prev, state: true }))}
                onBlur={() => setTimeout(() => setShowSuggestions(prev => ({ ...prev, state: false })), 200)}
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-indigo-600 text-white px-8 py-2.5 rounded-lg font-medium hover:bg-indigo-700 transition-colors"
            >
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-red-50 text-red-600 px-6 py-2.5 rounded-lg font-medium hover:bg-red-100 transition-colors border border-red-200"
              >
                <X className="w-5 h-5" />
                Clear All Filters
              </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={formData.city}
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${errors.city ? 'border-red-500' : 'border-gray-300'}`}
                  placeholder="Enter city"
                />
                {errors.city && (
                  <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.state}
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${errors.state ? 'border-red-500' : 'border-gray-300'}`}
                  placeholder="Enter state"
                />
                {errors.state && (
                  <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={formData.contact}
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${errors.contact ? 'border-red-500' : 'border-gray-300'}`}
                  placeholder="10-digit number"
                />
                {errors.contact && (
                  <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.email_id}
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${errors.email_id ? 'border-red-500' : 'border-gray-300'}`}
                  placeholder="school@example.com"
                />
                {errors.email_id && (
                  <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              {showSuggestions.name && getSuggestions('name').length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {getSuggestions('name').map((suggestion, index) => (
                    <div key={index} onClick={() => selectSuggestion('name', suggestion)} className="px-4 py-2 hover:bg-indigo-50 cursor-pointer text-sm text-gray-700 border-b last:border-b-0">
                      {suggestion}
                    </div>
                  ))}
                </div>
            ...
            <div className="relative">
              ...
              {showSuggestions.city && getSuggestions('city').length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {getSuggestions('city').map((suggestion, index) => (
                    <div key={index} onClick={() => selectSuggestion('city', suggestion)} className="px-4 py-2 hover:bg-indigo-50 cursor-pointer text-sm text-gray-700 border-b last:border-b-0">
                      {suggestion}
                    </div>
                  ))}
                </div>
            ...
            <div className="relative">
              ...
              {showSuggestions.state && getSuggestions('state').length > 0 && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {getSuggestions('state').map((suggestion, index) => (
                    <div key={index} onClick={() => selectSuggestion('state', suggestion)} className="px-4 py-2 hover:bg-indigo-50 cursor-pointer text-sm text-gray-700 border-b last:border-b-0">
                      {suggestion}
                    </div>
                  ))}
                </div>
